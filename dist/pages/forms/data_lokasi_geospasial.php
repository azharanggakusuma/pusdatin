      ...
      <div class="app-content">
        <div class="container-fluid">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
              <form action="../../handlers/form_poliklinik.php" method="post">
                <div class="form-group mb-3">
                  <label class="mb-2">Jumlah Poliklinik/Balai Pengobatan</label>
                  <input
                    type="number"
                    id="jumlahPoliklinik"
                    name="jumlah_poliklinik"
                    class="form-control"
                    placeholder="Masukkan jumlah Poliklinik/Balai Pengobatan"
                    min="0"
                    max="50"
                    step="1"
                    required />
            ...
            <script>
              document.addEventListener("DOMContentLoaded", function() {
                ...
                jumlahPoliklinikInput.addEventListener("input", function() {
                  ...
                  if (!isNaN(jumlah) && jumlah > 0) {
                    if (jumlah > 50) {
                      alert("Maksimal jumlah form yang dapat dibuat adalah 50.");
                      jumlahPoliklinikInput.value = 50;
                    }
              ...
              <div class="border p-3 mb-3">
                <div class="card-header mb-3">
                  <h4 class="card-title">Poliklinik/Balai Pengobatan Ke-${i}</h4>
                </div>
                <div class="row">
                  <div class="form-group mb-3">
                    <label class="mb-2">Nama Poliklinik/Balai Pengobatan</label>
                    <input
                      name="nama_poliklinik_${i}"
                      type="text"
                      class="form-control"
                      placeholder="Masukkan Nama Poliklinik/Balai Pengobatan"
                      required
                    />
                  </div>
                  <div class="form-group mb-3">
                    ...
                    <textarea
                      name="alamat_poliklinik_${i}"
                      class="form-control"
                      rows="3"
                      placeholder="Isi Alamat Poliklinik/Balai Pengobatan"
                      required
                    ></textarea>
                  </div>
                  <div class="form-group mb-3">
                    <label class="mb-2">Nama Kecamatan</label>
                    <input
                      name="nama_kecamatan_poliklinik_${i}"
                      type="text"
                      class="form-control"
                      placeholder="Masukkan Nama Kecamatan"
                      required
            ...
            <div class="modal fade" id="infoModalPoliklinik" tabindex="-1" aria-labelledby="infoModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="infoModalLabel">Panduan Pengisian Data Poliklinik/Balai Pengobatan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <ul>
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
              <form action="../../handlers/form_praktek_dokter.php" method="post">
                <div class="form-group mb-3">
                  <label class="mb-2">Jumlah Praktek Dokter</label>
                  <input
                    type="number"
                    id="jumlahPraktekDokter"
                    name="jumlah_praktek_dokter"
                    class="form-control"
                    placeholder="Masukkan jumlah Praktek Dokter"
                    min="0"
                    max="50"
                    step="1"
                    required />
            ...
            <script>
              document.addEventListener("DOMContentLoaded", function() {
                ...
                jumlahPraktekDokterInput.addEventListener("input", function() {
                  ...
                  if (!isNaN(jumlah) && jumlah > 0) {
                    if (jumlah > 50) {
                      alert("Maksimal jumlah form yang dapat dibuat adalah 50.");
                      jumlahPraktekDokterInput.value = 50;
                    }
              ...
              <div class="border p-3 mb-3">
                <div class="card-header mb-3">
                  <h4 class="card-title">Praktek Dokter Ke-${i}</h4>
                </div>
                <div class="row">
                  <div class="form-group mb-3">
                    <label class="mb-2">Nama Praktek Dokter</label>
                    <input
                      name="nama_praktek_dokter_${i}"
                      type="text"
                      class="form-control"
                      placeholder="Masukkan Nama Praktek Dokter"
                      required
                    />
                  </div>
                  <div class="form-group mb-3">
                    ...
                    <textarea
                      name="alamat_praktek_dokter_${i}"
                      class="form-control"
                      rows="3"
                      placeholder="Isi Alamat Praktek Dokter"
                      required
                    ></textarea>
                  </div>
                  <div class="form-group mb-3">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
              <form action="../../handlers/form_praktek_bidan.php" method="post">
                <div class="form-group mb-3">
                  <label class="mb-2">Jumlah Praktek Bidan</label>
                  <input
                    type="number"
                    id="jumlahPraktekBidan"
                    name="jumlah_praktek_bidan"
                    class="form-control"
                    placeholder="Masukkan jumlah Praktek Bidan"
                    min="0"
                    max="50"
                    step="1"
                    required />
            ...
            <script>
              document.addEventListener("DOMContentLoaded", function() {
                ...
                jumlahPraktekBidanInput.addEventListener("input", function() {
                  ...
                  if (!isNaN(jumlah) && jumlah > 0) {
                    if (jumlah > 50) {
                      alert("Maksimal jumlah form yang dapat dibuat adalah 50.");
                      jumlahPraktekBidanInput.value = 50;
                    }
              ...
              <div class="border p-3 mb-3">
                <div class="card-header mb-3">
                  <h4 class="card-title">Praktek Bidan Ke-${i}</h4>
                </div>
                <div class="row">
                  <div class="form-group mb-3">
                    <label class="mb-2">Nama Praktek Bidan</label>
                    <input
                      name="nama_praktek_bidan_${i}"
                      type="text"
                      class="form-control"
                      placeholder="Masukkan Nama Praktek Bidan"
                      required
                    />
                  </div>
                  <div class="form-group mb-3">
                    ...
                    <textarea
                      name="alamat_praktek_bidan_${i}"
                      class="form-control"
                      rows="3"
                      placeholder="Isi Alamat Praktek Bidan"
                      required
                    ></textarea>
                  </div>
                  <div class="form-group mb-3">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
              <form action="../../handlers/form_poskesdes.php" method="post">
                <div class="form-group mb-3">
                  <label class="mb-2">Jumlah POSKESDES</label>
                  <input
                    type="number"
                    id="jumlahPoskesdes"
                    name="jumlah_poskesdes"
                    class="form-control"
                    placeholder="Masukkan jumlah POSKESDES"
                    min="0"
                    max="50"
                    step="1"
                    required />
            ...
            <script>
              ...
              <div class="border p-3 mb-3">
                <div class="card-header mb-3">
                  <h4 class="card-title">POSKESDES Ke-${i}</h4>
                </div>
                <div class="row">
                  <div class="form-group mb-3">
                    <label class="mb-2">Nama POSKESDES</label>
                    <input
                      name="nama_poskesdes_${i}"
                      type="text"
                      class="form-control"
                      placeholder="Masukkan Nama POSKESDES"
                      required
                    />
                  </div>
                  <div class="form-group mb-3">
                    ...
                    <textarea
                      name="alamat_poskesdes_${i}"
                      class="form-control"
                      rows="3"
                      placeholder="Isi Alamat POSKESDES"
                      required
                    ></textarea>
                  </div>
                  <div class="form-group mb-3">
              ...
              <div class="border p-3 mb-3">
                ...
                <div class="row">
                  <div class="form-group mb-3">
                    ...
                    <input
                      name="nama_polindes_${i}"
                      type="text"
                      class="form-control"
                      placeholder="Masukkan Nama POLINDES"
                      required
                    />
                  </div>
                  <div class="form-group mb-3">
                    ...
                    <textarea
                      name="alamat_polindes_${i}"
                      class="form-control"
                      rows="3"
                      placeholder="Isi Alamat POLINDES"
                      required
                    ></textarea>
                  </div>
                  <div class="form-group mb-3">
