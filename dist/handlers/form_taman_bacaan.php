...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "INSERT INTO tb_taman_bacaan (keberadaan_tbm, user_id, desa_id)
            VALUES ('$keberadaan_tbm', '$user_id', '$desa_id')";

  if (mysqli_query($conn, $sql)) {
    // Tambahkan atau perbarui progres pengguna
    $query_progress = "INSERT INTO user_progress (user_id, form_name, is_locked, desa_id) 
                       VALUES ('$user_id', 'Keberadaan Taman Bacaan Masyarakat (TBM) / Perpustakaan Desa', TRUE, '$desa_id')
