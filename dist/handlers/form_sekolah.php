...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($data as $sekolah) {
        $sql = "INSERT INTO tb_sekolah (nama_sekolah, jenjang_pendidikan, status_sekolah, alamat_sekolah, nama_kecamatan, koordinat_lintang, koordinat_bujur, tahun, user_id, desa_id)
                VALUES (
                    ...
                    '{$sekolah['koordinat_lintang']}', 
                    '{$sekolah['koordinat_bujur']}', 
                    '$tahun', 
                    '$user_id', 
                    '$desa_id')";
