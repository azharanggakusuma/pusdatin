...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($data as $praktek) {
        $sql = "INSERT INTO tb_praktek_dokter (nama_praktek_dokter, alamat_praktek_dokter, nama_kecamatan, koordinat_lintang, koordinat_bujur, tahun, user_id, desa_id)
                VALUES (
                    '{$praktek['nama_praktek_dokter']}',
                    '{$praktek['alamat_praktek_dokter']}',
