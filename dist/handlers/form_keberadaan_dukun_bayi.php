...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "INSERT INTO tb_keberadaan_dukun_bayi (keberadaan_dukun_bayi, user_id, desa_id)
            VALUES ('$keberadaan_dukun_bayi', '$user_id', '$desa_id')";

  if (mysqli_query($conn, $sql)) {
    // Update user progress
    $query_progress = "INSERT INTO user_progress (user_id, form_name, is_locked, desa_id) 
                       VALUES ('$user_id', 'Keberadaan Dukun Bayi/Paraji yang menetap di Desa/Kelurahan', TRUE, '$desa_id')
