...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $check_query = "SELECT id 
                    FROM tb_titik_koordinat_kantor_desa 
                    WHERE user_id = '$user_id' 
                      AND desa_id = '$desa_id' 
                      AND tahun = '$tahun'";
  ...
  if (mysqli_num_rows($check_result) > 0) {
    ...
    $sql = "UPDATE tb_titik_koordinat_kantor_desa
                SET 
    ...
    $sql = "INSERT INTO tb_titik_koordinat_kantor_desa (
                    koordinat_lintang, 
                    koordinat_bujur, 
                    tahun, 
                    user_id, 
  ...
  if (mysqli_query($conn, $sql)) {
    ...
    $query_progress = "SELECT id
                           FROM user_progress
                           WHERE user_id = '$user_id'
                             AND form_name = 'Titik Koordinat Kantor Desa'
                             AND tahun = '$tahun'";
