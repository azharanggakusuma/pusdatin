...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tb_kondisi_kantor (kondisi_kantor, user_id, desa_id) 
            VALUES ('$kondisi_kantor', '$user_id', '$desa_id')";

    if (mysqli_query($conn, $sql)) {
        // Tambahkan atau perbarui progres pengguna
        $query_progress = "INSERT INTO user_progress (user_id, form_name, is_locked, desa_id) 
                           VALUES ('$user_id', 'Kondisi Kantor Kepala Desa/Balai Desa', TRUE, '$desa_id')
