...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="./img/people.png" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline"><?php echo $name; ?></span> </a>
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if ($level == 'admin') { ?>
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="./pages/tables/user.php" class="nav-link">
                                            <i class="nav-icon bi bi-circle"></i>
                                            <p>Data User</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="./pages/tables/rekap.php" class="nav-link">
                                            <i class="nav-icon bi bi-circle"></i>
                                            <p>Rekap Data</p>
                                        </a>
                                    </li>
    ...
    <script>
        ...
        fetch('./api/pengunjung.php') // Gantilah dengan path yang sesuai ke file PHP Anda
            ...
            .then(data => {
                const pengunjungData = data.map(item => item.jumlah_pengunjung);
                const bulanData = data.map(item => item.tanggal);
                ...
                const sales_chart_options = {
                    ...
                    xaxis: {
                        type: "datetime",
                        categories: bulanData, // Menggunakan data tanggal dari server
                    },
                    tooltip: {
                        x: {
                            format: "MMMM yyyy"
